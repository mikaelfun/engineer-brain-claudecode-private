# Fix Report: iss-192-copy-html-draft

**Test ID:** iss-192-copy-html-draft
**Fix Type:** framework_fix
**Description:** Fix check_page curl execution - remove duplicate '|| echo 000' causing HTTP status code duplication (000000 instead of 000)
**Modified Files:** tests/executors/ui-runner.sh,tests/executors/common.sh
**Fixed At:** 2026-03-31T19:11:44Z
**Recipe Used:** none

## What Was Fixed

Fix check_page curl execution - remove duplicate '|| echo 000' causing HTTP status code duplication (000000 instead of 000)
