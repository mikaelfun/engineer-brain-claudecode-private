# Fix Report: wf-iss115

**Test ID:** wf-iss115
**Fix Type:** code_bug
**Description:** Fixed cases_root path resolution (same systemic bug as wf-iss111): PROJECT_ROOT with spaces → node -e path failure → PROJ_ROOT env var pattern in common.sh
**Modified Files:** tests/executors/common.sh
**Fixed At:** 2026-03-29T19:43:20Z
**Recipe Used:** none

## What Was Fixed

Fixed cases_root path resolution (same systemic bug as wf-iss111): PROJECT_ROOT with spaces → node -e path failure → PROJ_ROOT env var pattern in common.sh
