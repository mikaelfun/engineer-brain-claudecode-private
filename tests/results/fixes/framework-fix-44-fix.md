# Fix Report: framework-fix-44

**Test ID:** framework-fix-44
**Fix Type:** framework_fix
**Description:** Added bash_exit_zero and bash_output_* delegation to _flush_bash_check_assertion in e2e-runner.sh. The function was missing case branches for these assertion types, causing 'unbound variable STEP_OUTPUT_source' errors when bash-check tests used these assertions.
**Modified Files:** tests/executors/e2e-runner.sh
**Fixed At:** 2026-03-31T21:40:58Z
**Recipe Used:** none

## What Was Fixed

Added bash_exit_zero and bash_output_* delegation to _flush_bash_check_assertion in e2e-runner.sh. The function was missing case branches for these assertion types, causing 'unbound variable STEP_OUTPUT_source' errors when bash-check tests used these assertions.
...
@@ -578,43 +659,287 @@ run_standalone_bash_assertions() {
     fi
...
@@ -803,8 +1128,46 @@ verify_case_outputs() {
       fi
     fi
...
+    if echo "$line" | grep -q 'type: .json_field"'; then
       ...
       local field=""
       local expected=""
@@ -854,6 +1217,61 @@ verify_case_outputs() {
         esac
       fi
     fi
+
...
+    fi
 ...
 # ============================================================
@@ -915,6 +1333,7 @@ case "$WORKFLOW_TYPE" in
                 run_standalone_bash_assertions
                 ;;
...
@@ -925,11 +1344,17 @@ ELAPSED=$(get_elapsed_ms)
 OVERALL_STATUS="pass"
