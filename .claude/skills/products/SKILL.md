...
> Kusto query templates live in `.claude/skills/kusto/{product}/`; product skills reference but don't duplicate them.
...
```
            ...
            +-------------+-------------+
            v                           v
    .claude/skills/products/              .claude/skills/kusto/
    {product}/                    {product}/
    +------------------------+    +-------------------+
