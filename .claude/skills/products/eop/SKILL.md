...
```
工具: .claude/skills/kusto/eop/references/decodingspamagentdata.ps1
...
- **PowerShell**: `.claude/skills/kusto/eop/references/decodingspamagentdata.ps1`
