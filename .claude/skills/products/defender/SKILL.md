# DEFENDER Troubleshooting Skill

> Product skill for defender.
...
```
.claude/skills/products/defender/
  known-issues.jsonl          1109 entries (structured break/fix triples)
  guides/
    ...
    drafts/*.md               283 raw extraction drafts (source material, do not delete)
...
- New knowledge: `/product-learn add defender` or auto-enriched via `/product-learn auto-enrich`
- Re-synthesize after significant new entries: `/product-learn synthesize defender`
- Promote high-confidence entries to this SKILL.md: `/product-learn promote defender`
