---
source: ado-wiki
sourceRef: "Supportability/AzureAD/AzureAD:/GeneralPages/AAD/AAD Authentication/ADFS and WAP/ADFS Databases/ADFS Upgrade ADFS running on WID from 2012R2 to 2016"
...
# Upgrading to AD FS in Windows Server 2016 using a WID database from 2012R2
...
## Upgrading a Windows Server 2012 R2 to Windows Server 2016

The following document will describe how to upgrade your AD FS farm in Windows
Server 2012R2 to AD FS in Windows Server 2016 when you are using a WID database.
...
-   Before the FBL can be raised, administrators must remove the AD FS nodes of
    ...
    note that this requires one of the new Windows Server 2016 federation
...
-   Once all federation servers in the farm are at the same Windows Server
    ...
    2016 features can then be configured and used.

Be aware that while in mixed farm mode, the AD FS farm is not capable of any new
features or functionality introduced in AD FS in Windows Server 2016. This means
...
Server 2016 federation server to a Windows Server 2012 R2 environment and then
raising the FBL to Windows Server 2016.**

**Note**

Before you can move to AD FS in Windows Server 2016 FBL, you must remove all the
Windows Server 2012 R2 nodes. You cannot just upgrade a Windows Server 2012 R2
OS to Windows Server 2016 and have it become a 2016 node. You will need to
remove it and replace it with a new 2016 node.
...
![](/.attachments/AAD-Authentication/387275/adfswizard.png)
...
![](/.attachments/AAD-Authentication/387275/adfsnotprimary.png)
...
![](/.attachments/AAD-Authentication/387275/roleprimarycomputer.png)
...
![](/.attachments/AAD-Authentication/387275/syncpropertiesrole.png)
...
![](/.attachments/AAD-Authentication/387275/adfsmain.png)
...
![](/.attachments/AAD-Authentication/387275/fsmo.png)
...
>   To upgrade the schema, With the Windows Server 2016 installation media, open
>   a command prompt and navigate to support\\adprep directory. Run the
>   following:?adprep /forestprep

![](/.attachments/AAD-Authentication/387275/dc1contoso.png)
...
![](/.attachments/AAD-Authentication/387275/adprep.png)
...
![](/.attachments/AAD-Authentication/387275/testadfsfarm.png)

> Invoke-AdfsFarmBehaviorLevelRaise

![](/.attachments/AAD-Authentication/387275/WIDPRECHECK.png)
...
![](/.attachments/AAD-Authentication/387275/invokeraise.png)
...
![](/.attachments/AAD-Authentication/387275/servicesoverview.png)
...
![](/.attachments/AAD-Authentication/387275/getadfsfarm.png)

> In 2016 ADFS farm you should see ?3? in the ?Current Farm Behavior? above.
