...
**来源草稿**: 无
**Kusto 引用**: image-integrity.md, pod-restart-analysis.md, pod-subnet-sharing.md
**场景数**: 3
**生成日期**: 2026-04-07

---

## Scenario 1: Kusto 诊断: Image Integrity 功能查询
...
## Scenario 2: Kusto 诊断: Pod 重启分析查询
...
## Scenario 3: Kusto 诊断: Pod Subnet 共享查询
