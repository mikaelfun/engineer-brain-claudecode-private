# AKS Azure Container Storage — general — 排查工作流

**来源草稿**: ado-wiki-recovery-of-azure-container-registry.md
**Kusto 引用**: 无
**场景数**: 1
**生成日期**: 2026-04-07
...
## Scenario 1: Recovery of Deleted Azure Container Registry (ACR)
> 来源: ado-wiki-recovery-of-azure-container-registry.md | 适用: 适用范围未明确
