# AKS 集群版本升级 — pdb — 排查工作流

**来源草稿**: ado-wiki-b-maxUnavailable-Setting.md
**Kusto 引用**: auto-upgrade.md, cluster-snapshot.md, scale-upgrade-operations.md
**场景数**: 1
**生成日期**: 2026-04-07

---

## Scenario 1: Upgrade with maxUnavailable
> 来源: ado-wiki-b-maxUnavailable-Setting.md | 适用: 适用范围未明确
