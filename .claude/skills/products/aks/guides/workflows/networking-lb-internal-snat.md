# AKS 内部负载均衡器 — snat — 排查工作流

**来源草稿**: mslearn-outbound-connectivity-troubleshooting.md
**Kusto 引用**: 无
**场景数**: 1
**生成日期**: 2026-04-07
...
## Scenario 1: Outbound Connectivity Troubleshooting (AKS)
> 来源: mslearn-outbound-connectivity-troubleshooting.md | 适用: Mooncake ✅
