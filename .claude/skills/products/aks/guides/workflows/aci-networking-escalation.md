# AKS ACI 网络与 DNS — escalation — 排查工作流

**来源草稿**: ado-wiki-a-aci-kusto-helpers.md, ado-wiki-b-aci-kusto-queries.md
**Kusto 引用**: 无
**场景数**: 2
**生成日期**: 2026-04-07
...
## Scenario 1: Kusto Helpers
> 来源: ado-wiki-a-aci-kusto-helpers.md | 适用: 适用范围未明确
...
## Scenario 2: ACI Kusto Queries
> 来源: ado-wiki-b-aci-kusto-queries.md | 适用: 适用范围未明确
...
Kenneth Gonzalez Pineda has put together a comprehensive set of Kusto queries that are compatible with the Kusto Repo tool he built out. By combining the tool with the queries, you can get queries that are dynamically populated with the appropriate values for your environment.

* [Kusto Repo Tool](/Azure-Kubernetes-Service-Wiki/ACT-Team/Tools/Kusto-Repo.md)
* [ACI Kusto Repo](/Azure-Kubernetes-Service-Wiki/ACT-Team/Tools/Kusto-Repo/Kusto-Repo-ACI.md)
...
**Contributors:**
- Carlos Luis Porras <Carlos.Porras@microsoft.com>
