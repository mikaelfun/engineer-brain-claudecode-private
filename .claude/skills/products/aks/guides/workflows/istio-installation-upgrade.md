# AKS Istio 安装与配置 — upgrade — 排查工作流

**来源草稿**: ado-wiki-a-CrashLoopBackOff-Status.md
...
## Scenario 1: Pods stuck in CrashLoopBackOff status
> 来源: ado-wiki-a-CrashLoopBackOff-Status.md | 适用: 适用范围未明确
