# AKS UDR 与路由 — ossku — 排查工作流

**来源草稿**: ado-wiki-resolv-conf-generation-aks-ubuntu-2204.md
**Kusto 引用**: 无
**场景数**: 1
**生成日期**: 2026-04-07
...
## Scenario 1: How the /etc/resolv.conf generated on ubuntu 2204?
> 来源: ado-wiki-resolv-conf-generation-aks-ubuntu-2204.md | 适用: 适用范围未明确
