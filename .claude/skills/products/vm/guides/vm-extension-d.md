...
| 3 | Azure can host a large amount of Operating Systems (OSs), for extensions, this is the list of OSÆs t... | Reference doc (no explicit root cause)... | See original document for detailed steps... | 🟡 5.0 | KB |
| 4 | Action : Performing Domain Join of Azure VMÆs using JSON Extension More Information: Extension : Azu... | Reference doc (no explicit root cause)... | See original document for detailed steps... | 🟡 5.0 | KB |
