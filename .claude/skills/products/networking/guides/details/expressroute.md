...
→ 详见 `.claude/skills/kusto/networking/references/queries/er-circuit.md`

`[工具: Kusto skill — er-gateway.md]`
→ 详见 `.claude/skills/kusto/networking/references/queries/er-gateway.md`

`[工具: Kusto skill — server-tor.md]`
→ 详见 `.claude/skills/kusto/networking/references/queries/server-tor.md`
