...
| 2026-04-21 | mslearn | +4 Wi-Fi profile break/fix entries (certificate mismatch, password change, Android Enterprise reporting, false failure). 8 URLs scanned (wi-fi profiles, CSP custom settings, OMA-URI deploy, Android Enterprise config, ESP troubleshoot, Entra device registration/Autopilot, GP auto-enrollment, duplicate MDM). Drafts already existed from prior partial run. 4 URLs remaining. | troubleshoot-wi-fi-profiles, troubleshoot-csp-custom-settings, deploy-oma-uris, configure-android-enterprise, understand-troubleshoot-esp, azure-ad-device-registration-autopilot, troubleshoot-windows-auto-enrollment, remove-duplicate-mdm |
| 2026-04-21 | mslearn | +6 Track B guide drafts (CSP, Wi-Fi, Autopilot/Entra reg, Android Enterprise, auto-enrollment, ESP); 0 Track A (all 8 pages deduplicated against existing entries) | batch 8 URLs |
| 2026-04-23 | mslearn | +3 intune known issues (update-rings co-mgmt/TargetReleaseVersion, iOS SSL/ATS); 2 skipped (ref table, support-call prep); 0 dedup | troubleshoot-update-rings, troubleshoot-company-resource-access |
| 2026-04-24 | SYNTHESIZE | 49 topics (41 fusion, 8 compact), 4166 entries, 18 Kusto queries fused |
