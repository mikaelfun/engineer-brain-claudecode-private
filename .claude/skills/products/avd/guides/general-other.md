...
**Entries**: 13 | **21V**: partial
**Keywords**: activation, ad-ds, api-deprecation, application-group, applocker, auto-scaling, automation, azure-files
**Last updated**: 2026-04-07

> Note: avd-ado-wiki-0861 and avd-mslearn-040 have context-dependent differences (21v_conflict)
> Note: avd-ado-wiki-0862 and avd-mslearn-040 have context-dependent differences (21v_conflict)
> Note: avd-ado-wiki-0862 and avd-mslearn-052 have context-dependent differences (21v_conflict)
...
1. Check: Platform bug on specific AVD multi-session images `[Source: OneNote]`
2. Check: Microsoft retiring preview API versions for Azure `[Source: OneNote]`
3. Check: Cloud PCs in inactive state (unused for a while) r `[Source: ADO Wiki]`
4. Check: rdpclipcdv.exe and rdpinputcdv.exe blocked by AppL `[Source: MS Learn]`
5. Check: Not assigned to app groups, cached creds, or distr `[Source: MS Learn]`
