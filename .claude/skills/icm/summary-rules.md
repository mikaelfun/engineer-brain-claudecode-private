...
```powershell
& ".claude/skills/agency-icm/scripts/get-incident-summary.ps1" `
...
```powershell
& ".claude/skills/agency-icm/scripts/get-incident-details.ps1" `
  -IncidentId 626495494
```
...
```powershell
& ".claude/skills/agency-icm/scripts/get-incident-context.ps1" `
  -IncidentId 626495494
```
...
```powershell
& ".claude/skills/agency-icm/scripts/get-similar-incidents.ps1" `
  -IncidentId 626495494
```
...
```powershell
& ".claude/skills/agency-icm/scripts/get-incident-location.ps1" `
  -IncidentId 626495494
```
...
```powershell
& ".claude/skills/agency-icm/scripts/get-incident-customer-impact.ps1" `
  -IncidentId 626495494
```
...
```powershell
& ".claude/skills/agency-icm/scripts/get-mitigation-hints.ps1" `
  -IncidentId 626495494
```
...
```powershell
& ".claude/skills/agency-icm/scripts/get-support-requests-critsit.ps1" `
  -IncidentId 626495494
```
...
```powershell
& ".claude/skills/agency-icm/scripts/is-specific-customer-impacted.ps1" `
  -IncidentId 626495494 `
...
```powershell
& ".claude/skills/agency-icm/scripts/get-team-by-id.ps1" `
  -TeamId 86687
```
...
```powershell
& ".claude/skills/agency-icm/scripts/get-teams-by-name.ps1" `
...
```powershell
& ".claude/skills/agency-icm/scripts/get-teams-by-public-id.ps1" `
...
```powershell
& ".claude/skills/agency-icm/scripts/get-on-call-schedule-by-team-id.ps1" `
  -TeamIds 86687
```
...
```powershell
& ".claude/skills/agency-icm/scripts/get-services-by-names.ps1" `
...
```powershell
& ".claude/skills/agency-icm/scripts/get-impacted-services-regions-clouds.ps1" `
  -IncidentId 626495494
```
