---
source: ado-wiki
sourceRef: "Supportability/AzureMonitor/AzureMonitor.wiki:/Monitor Agents/Agents/Microsoft Monitoring Agent (MMA) for Windows/How-To/Windows Support Tool Guide"
sourceUrl: "https://dev.azure.com/Supportability/AzureMonitor/_wiki/wikis/AzureMonitor.wiki?pagePath=/Monitor%20Agents/Agents/Microsoft%20Monitoring%20Agent%20%28MMA%29%20for%20Windows/How-To/Windows%20Support%20Tool%20Guide"
...
The Log Analytics Agent Windows Troubleshooting Tool is a collection of PowerShell scripts designed to help find and diagnose issues with the Log Analytics Agent. It is automatically included with the agent build 10.20.18053.0 and onwards upon installation. <br /><br />For earlier Agent builds, it can be downloaded from [**here**](https://microsoft.sharepoint.com/:u:/t/EMEAAMASupport/EbQFjYiynpNAsD3UHV3402cBFa6m37zs8H-9ntN93s-aww?e=QCRHQu). 
...
- Make sure Execution Policy is set to right settings:
Set-ExecutionPolicy AllSigned CurrentUser -Force
![image.png](/.attachments/image-49014a8f-f685-4e9b-a617-970d85ab7e20.png)
...
# <span style="color: #4169E1">Things to Remember</span>
---
<br />
...
- When data collection tool reaches Network Trace collection stage, please have customer via command prompt (running under Admin privileges) execute ipconfig/flushdns. This will help network trace to capture name resolution as result of dns cache flush. This will help during network trace analysis to recognize machines by their friendly names.
