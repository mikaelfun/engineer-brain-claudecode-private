---
source: ado-wiki
sourceRef: "Supportability/AzureMonitor/AzureMonitor.wiki:/Monitoring Essentials/Activity Logs/Troubleshooting Guides/Troubleshooting configuring export of activity logs in Azure portal"
sourceUrl: "https://dev.azure.com/Supportability/AzureMonitor/_wiki/wikis/AzureMonitor.wiki?pagePath=/Monitoring%20Essentials/Activity%20Logs/Troubleshooting%20Guides/Troubleshooting%20configuring%20export%20of%20activity%20logs%20in%20Azure%20portal"
...
# Scenario
---
This troubleshooting guide applies to configuring the legacy feature of Activity Log Export known as [Log profiles](https://docs.microsoft.com/azure/azure-monitor/essentials/activity-log#log-profiles).
...
- The verbatim of any error message(s) that were seen in the Azure portal when attempting to create or update the configuration.
...
1. **Review verbatim error message(s) or screenshots of errors provided for clues**
   ...
   If an error occurred, the Azure portal experience tries to let the user know the reason.  Examine any such messages for indications of why the attempted action failed (for example user doesn't have permissions).
...
1. **Reproduce the issue with session details and tracing.**

   Have the customer reproduce the problem while capturing session information and tracing.

   [How to get internal blade details from the Azure portal](/Azure-Monitor/How%2DTo/General/How-to-get-internal-blade-details-from-the-Azure-portal)
