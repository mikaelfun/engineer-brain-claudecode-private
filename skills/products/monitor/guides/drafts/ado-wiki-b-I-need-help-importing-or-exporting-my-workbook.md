---
source: ado-wiki
sourceRef: "Supportability/AzureMonitor/AzureMonitor.wiki:/Insights, Workbooks and Managed Products/Workbooks/Support Topics/Issue with managing workbooks/I need help importing or exporting my workbook"
sourceUrl: "https://dev.azure.com/Supportability/AzureMonitor/_wiki/wikis/AzureMonitor.wiki?pagePath=/Insights%2C%20Workbooks%20and%20Managed%20Products/Workbooks/Support%20Topics/Issue%20with%20managing%20workbooks/I%20need%20help%20importing%20or%20exporting%20my%20workbook"
...
# Scenario
---
_Any issues related to importing or exporting a Workbook template._
...
- User is asking how to import or export a Workbook template.
...
# Data Collection
---
1. The JSON of the template they are trying to import, or the Workbook they are trying to export.
2. Are there any error messages when attempting to import/export the Workbook?
...
---
[Wiki | Import a Workbook](https://dev.azure.com/Supportability/AzureMonitor/_wiki/wikis/AzureMonitor.wiki/862915/Import-Customer-Workbook-Into-The-Portal-For-Analysis)
[Public Doc | Azure Workbooks Overview](https://learn.microsoft.com/azure/azure-monitor/visualize/workbooks-overview)
[Public Doc | Deploy Azure Workbooks](https://learn.microsoft.com/azure/azure-monitor/visualize/workbooks-automate)
