...
- `Intune > Windows TSG > Windows LAPS with Azure AD`

## Scenario 1: Read LAPS metadata stored in Azure AD
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 2: Recover LAPS passwords stored in Azure AD
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 3: Custom Azure AD RBAC roles
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 4: Does Windows LAPS create local admin account (when not present) based on the administrator account name configured using LAPS policy?
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 5: What are license requirements for using Windows LAPS?
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 6: Issue 1: Passwords not Updated in Azure AD
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 7: Solution 1: Passwords not Updated in Azure AD
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 8: Grant Permission to Modify Device Settings Policy
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 9: Enable Azure AD Local Administrator Password Solution in AD RS
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 10: Grant Permission to View LAPS Metadata
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 11: Show local admin password metadata for all devices
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 12: Show local admin password metadata for one device
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 13: Show Base64 Encoded local admin password
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 14: Microsoft Graph PowerShell
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 16: Event Viewer Logs (LAPS)
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 19: Local Administrator Password (ASC)
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 21: Microsoft Graph (ASC)
> 来源: ado-wiki-a-Windows-LAPS-Cloud-LAPS.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 23: 配置项
> 来源: onenote-laps-automatic-account-management.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 26: Intune Team Owns
> 来源: onenote-laps-azure-ad-support-guide.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 27: Windows Directory Services Team Owns
> 来源: onenote-laps-azure-ad-support-guide.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 28: Azure Identity Team Owns
> 来源: onenote-laps-azure-ad-support-guide.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 29: Query 1: Trace LAPS password update from Event Log
> 来源: onenote-laps-azure-ad-support-guide.md | 适用: Mooncake ✅ / Global ✅
...
| project env_time, message
```
`[来源: onenote-laps-azure-ad-support-guide.md]`

## Scenario 30: Query 2: Service-side trace via FindTraceLogs
> 来源: onenote-laps-azure-ad-support-guide.md | 适用: Mooncake ✅
...
## Scenario 31: ASC Troubleshooting
> 来源: onenote-laps-event-log-troubleshooting.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 32: Common Error Codes
> 来源: onenote-laps-event-log-troubleshooting.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 33: Step 1: Enable LAPS in Azure AD
> 来源: onenote-windows-laps-azure-ad-configuration.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 34: Step 2: Create Intune Account Protection Policy
> 来源: onenote-windows-laps-azure-ad-configuration.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 35: Step 3: Recover Local Admin Password
> 来源: onenote-windows-laps-azure-ad-configuration.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 36: Step 4: Manual Password Rotation
> 来源: onenote-windows-laps-azure-ad-configuration.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 38: Prerequisites
> 来源: onenote-windows-laps-azure-ad.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 39: 1. Enable LAPS in Azure AD
> 来源: onenote-windows-laps-azure-ad.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 40: 2. Create Intune LAPS Policy
> 来源: onenote-windows-laps-azure-ad.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 41: Query 2: FindTraceLogs (Password Update Issues)
> 来源: onenote-windows-laps-kusto-queries.md | 适用: Mooncake ✅
...
cluster("idsharedwus.kusto.windows.net").database('ADRS').FindTraceLogs(t, delta, ids)
```
`[来源: onenote-windows-laps-kusto-queries.md]`
...
## Scenario 42: Intune Support Team
> 来源: onenote-windows-laps-support-boundaries.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 43: Windows Directory Services Team
> 来源: onenote-windows-laps-support-boundaries.md | 适用: Mooncake ✅ / Global ✅
...
## Scenario 44: Azure Identity Team
> 来源: onenote-windows-laps-support-boundaries.md | 适用: Mooncake ✅ / Global ✅
