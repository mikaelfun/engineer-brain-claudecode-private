# AKS AAD 集成与认证 — general — 排查工作流

**来源草稿**: ado-wiki-c-Trusted-Access.md, onenote-aks-jit-access-escort.md
**Kusto 引用**: 无
**场景数**: 2
**生成日期**: 2026-04-07
...
## Scenario 1: Trusted Access
> 来源: ado-wiki-c-Trusted-Access.md | 适用: 适用范围未明确
...
## Scenario 2: AKS JIT Access 获取流程（Mooncake Escort）
> 来源: onenote-aks-jit-access-escort.md | 适用: Mooncake ✅
