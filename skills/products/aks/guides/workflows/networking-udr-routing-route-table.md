# AKS UDR 与路由 — route-table — 排查工作流

**来源草稿**: ado-wiki-move-pv-data-between-clusters.md
**Kusto 引用**: 无
**场景数**: 1
**生成日期**: 2026-04-07
...
## Scenario 1: Move persistent volume data from one cluster to another
> 来源: ado-wiki-move-pv-data-between-clusters.md | 适用: 适用范围未明确
