# AKS 集群版本升级 — auto-upgrade — 排查工作流

**来源草稿**: 无
**Kusto 引用**: auto-upgrade.md, cluster-snapshot.md, lts-status.md, scale-upgrade-operations.md
**场景数**: 4
**生成日期**: 2026-04-07
...
## Scenario 3: Kusto 诊断: LTS 状态检查
> 来源: lts-status.md | 适用: Mooncake ✅
...
## Scenario 4: Kusto 诊断: Scale/Upgrade 操作查询
