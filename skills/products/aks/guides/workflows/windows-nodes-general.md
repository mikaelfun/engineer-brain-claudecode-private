# AKS Windows 节点通用 — 排查工作流

**来源草稿**: ado-wiki-installing-scoop-windows-nodes.md, ado-wiki-tcpdump-on-windows-nodes.md, ado-wiki-troubleshooting-aks-windows-nodes.md
**Kusto 引用**: 无
**场景数**: 3
**生成日期**: 2026-04-07
...
## Scenario 1: Installing scoop on Windows nodes
> 来源: ado-wiki-installing-scoop-windows-nodes.md | 适用: 适用范围未明确
...
## Scenario 2: Using tcpdump on Windows nodes in AKS
> 来源: ado-wiki-tcpdump-on-windows-nodes.md | 适用: 适用范围未明确
...
## Scenario 3: Troubleshooting Windows Nodes in AKS Clusters
> 来源: ado-wiki-troubleshooting-aks-windows-nodes.md | 适用: 适用范围未明确
