# AVD AVD Session Host (Part 1) - Quick Reference
...
1. Check: Network issues causing user connectivity drop when `[Source: KB]`
2. Check: RPC communication issue with Domain Controller, bl `[Source: KB]`
3. Check: Windows 10/11 multi-session lacks the shell32 Defa `[Source: KB]`
4. Check: CrashOnAuditFail registry key at HKLM\System\Curre `[Source: KB]`
5. Check: Remote Desktop Session Host role is required for s `[Source: KB]`

> This topic has a fusion troubleshooting guide with detailed workflow and Kusto queries
> -> [Full troubleshooting flow](details/avd-session-host-1.md#troubleshooting-flow)
