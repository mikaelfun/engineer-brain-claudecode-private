# AVD AVD 自定义镜像 (Part 1) - Quick Reference

**Entries**: 15 | **21V**: partial
**Keywords**: agent, agent-registration, antivirus, backup, cdpsvc, compute-gallery, connectivity, container-instance
...
1. Check: Master image was captured from a VM already joined `[Source: OneNote]`
2. Check: Custom image was created from a VM that was alread `[Source: ADO Wiki]`
3. Check: Connected Devices Platform Service (cdpsvc) is dis `[Source: ADO Wiki]`
4. Check: Pre-installed antivirus solutions (e.g., Sophos) o `[Source: ADO Wiki]`
5. Check: Specified resource group for Azure Image Builder c `[Source: MS Learn]`

> This topic has a fusion troubleshooting guide with detailed workflow and Kusto queries
> -> [Full troubleshooting flow](details/avd-custom-image-1.md#troubleshooting-flow)
