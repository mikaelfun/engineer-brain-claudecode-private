---
source: ado-wiki
sourceRef: "Supportability/AzureAD/AzureAD:/Authentication/Device Registration/Window Devices/Windows Local Administrator Password Solution Backed up to Azure AD"
sourceUrl: "https://dev.azure.com/Supportability/AzureAD/_wiki/wikis/AzureAD?pagePath=%2FAuthentication%2FDevice%20Registration%2FWindow%20Devices%2FWindows%20Local%20Administrator%20Password%20Solution%20Backed%20up%20to%20Azure%20AD"
...
[**Tags**](/Tags): [AAD](/Tags/AAD) [AAD-Devices](/Tags/AAD%2DDevices) [AAD-Workflow](/Tags/AAD%2DWorkflow) [AzureAD](/Tags/AzureAD) 
...
These roles use the `deviceLocalCredentials.ReadBasic.All` Microsoft Graph API Permission, which equates to `microsoft.directory/deviceLocalCredentials/standard/read`.
...
These roles use the `deviceLocalCredentials.Read.All` Microsoft Graph API Permission, which equates to `microsoft.directory/deviceLocalCredentials/password/read`.
...
These permissions are now available for AADP1+ customers using LAPS and can be used with Custom Azure AD roles.
...
The Windows Platforms Directory Services wiki page also has events of interest in their [Troubleshooting using Windows LAPS Events](https://dev.azure.com/raviks/WinTSGTestWiki/_wiki/wikis/WinTSGTestWiki.wiki?PageID=248) wiki page.
...
**Course Location**: [QA](https://aka.ms/AAk7sgw)
